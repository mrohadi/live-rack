...
func TestZoneHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/api/v1/stores/"+storeID.String()+"/zones", bytes.NewReader(body))
...
func TestZoneHandler_Get(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/api/v1/stores/"+storeID.String()+"/zones/"+created.ID.String(), nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
...
func TestZoneHandler_List(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/api/v1/stores/"+storeID.String()+"/zones", nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
	c.SetParamNames("storeID")
	c.SetParamValues(storeID.String())
...
func TestZoneHandler_Update(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPut, "/api/v1/stores/"+storeID.String()+"/zones/"+created.ID.String(), bytes.NewReader(body))
	req.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
	c.SetParamNames("storeID", "id")
...
func TestZoneHandler_Delete(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodDelete, "/api/v1/stores/"+storeID.String()+"/zones/"+created.ID.String(), nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
	c.SetParamNames("storeID", "id")
	c.SetParamValues(storeID.String(), created.ID.String())
...
func TestZoneHandler_Get_NotFound(t *testing.T) {
	...
	missingID := uuid.New()
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/api/v1/stores/"+storeID.String()+"/zones/"+missingID.String(), nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
	c.SetParamNames("storeID", "id")
